prueba-asdrubal-lucas-prieto

Project Structure

- front-page.php: Main page template that includes three sections.
...
- Custom WordPress template ready for installation in any WordPress environment.

- Structure split into three modular sections using includes.
...
2.- Place the folder in your /wp-content/themes/ directory.
